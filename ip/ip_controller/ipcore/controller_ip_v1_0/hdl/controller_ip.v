// -------------------------------------------------------------
// 
// File Name: D:\buck_conv\ip_controller\hdlsrc\controller_only\controller_ip.v
...
module controller_ip
  ...
  wire signed [15:0] write_vmeans;  // sfix16
  wire signed [15:0] write_vref;  // sfix16
  wire ce_out_sig;  // ufix1
  wire signed [15:0] duty_sig;  // sfix16


  assign ip_timestamp = 32'b10011011000110100010001110011101;

  assign reset_cm =  ~ IPCORE_RESETN;

  assign reset_before_sync = reset_cm | reset_internal;

  controller_ip_reset_sync u_controller_ip_reset_sync_inst (.clk(IPCORE_CLK),  // ufix1
                                                            .reset_in(reset_before_sync),  // ufix1
                                                            .reset_out(reset)
                                                            );

  controller_ip_dut u_controller_ip_dut_inst (.clk(IPCORE_CLK),  // ufix1
                                              .reset(reset),
                                              .dut_enable(write_axi_enable),  // ufix1
                                              .vmeans(write_vmeans),  // sfix16
                                              .vref(write_vref),  // sfix16
                                              .ce_out(ce_out_sig),  // ufix1
                                              .duty(duty_sig)  // sfix16
                                              );

  controller_ip_axi_lite u_controller_ip_axi_lite_inst (.reset(reset),
